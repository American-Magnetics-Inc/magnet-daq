...
**The current application version is 0.99**. The one remaining major application element to add is integrated Help files.

The Magnet-DAQ application *requires* firmware version 2.52 or later in the Model 430 programmer. An integrated Firmware Upgrade Wizard is included in the application along with the applicable firmware. Upon connection to a Model 430, the application will present the Firmware Upgrade Wizard as appropriate.
